...
Из 219 извлечённых объектов пригодными оказались 34, после отбора по контакт-листу в дело пошли 12. Десерты лежали в PDF без маски — им сделал knockout заливкой от краёв (`knockout.py` из того же scroll-world). Итог: блюда «летают» по кремовому фону без рамок, плашек и круглых масок — 356 КБ на всю съёмку в WebP.
