...
function mountScrollWorld(container, config) {
  ...
  // [GIRAFFE patch] Апстрим считает, что трек начинается на самом верху документа
  ...
  function read() {
    ...
    // [GIRAFFE patch] прогресс и подсказка тоже считаются от начала главы, не документа
    const rel = y - base;
